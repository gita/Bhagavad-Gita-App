class ChapterDetailData {
    ...
    factory ChapterDetailData.fromJson(Map<String, dynamic> json) => ChapterDetailData(
...
class GitaVersesByChapterId {
    ...
    factory GitaVersesByChapterId.fromJson(Map<String, dynamic> json) => GitaVersesByChapterId(
        nodes: List<GitaVersesByChapterIdNode>.from(json["nodes"].map((x) => GitaVersesByChapterIdNode.fromJson(x))),
    );
...
class GitaVersesByChapterIdNode {
    ...
    factory GitaVersesByChapterIdNode.fromJson(Map<String, dynamic> json) => GitaVersesByChapterIdNode(
        chapterNumber: json["chapterNumber"],
        verseNumber: json["verseNumber"],
        gitaTranslationsByVerseId: GitaTranslationsByVerseId.fromJson(json["gitaTranslationsByVerseId"]),
    );
...
class GitaTranslationsByVerseId {
    ...
    factory GitaTranslationsByVerseId.fromJson(Map<String, dynamic> json) => GitaTranslationsByVerseId(
        nodes: List<GitaTranslationsByVerseIdNode>.from(json["nodes"].map((x) => GitaTranslationsByVerseIdNode.fromJson(x))),
    );
